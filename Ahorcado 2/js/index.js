...
window.onload = function () {
  ...
  volverinicio.addEventListener("click", e => muestraocultainicio("volverinicio"));
};
...
function anadirCorazonesVida() {
  for (let index = 1; index <= ahorcado.vidas; index++) {
    if (!impresoBarraVidas) {
      ...
      document.getElementById("vida"+index).style.display="inline"
    }
